...
public class ControlFlowView extends AbstractTimeGraphView {
    ...
    protected Table<ITmfTrace, Long, ControlFlowEntry> fControlFlowEntries = HashBasedTable.create();

    @NonNull
	protected ActiveThreadsFilter fActiveThreadsFilter = new ActiveThreadsFilter(null, false, null);
                    ...
                    for (ThreadEntryModel entry : model) {
                        if (entry.getThreadId() != Integer.MIN_VALUE) {
                            ...
                            if (e != null) {
                                ...
                                fEntriesTid.put(entry.getThreadId(), entry.getId());
                            }
                        } else {
     ...
     */
    protected static Table<ThreadStatusDataProvider, Long, ControlFlowEntry> filterGroup(Iterable<TimeGraphEntry> visible,
    ...
    protected static ITimeEvent createTimeEvent(ControlFlowEntry controlFlowEntry, ITimeGraphState state) {
